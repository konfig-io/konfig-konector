...
// DBClusterParameterGroupSpec defines the desired state of an RDS DB Cluster Parameter Group.
type DBClusterParameterGroupSpec struct {
	...
	// DBClusterParameterGroupName is the name of the cluster parameter group. Immutable after creation.
	// +kubebuilder:validation:MinLength=1
	// +kubebuilder:validation:MaxLength=255
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="dbClusterParameterGroupName is immutable"
	DBClusterParameterGroupName string `json:"dbClusterParameterGroupName"`

	// DBParameterGroupFamily is the Aurora engine family (e.g. aurora-mysql8.0, aurora-postgresql15).
	// +kubebuilder:validation:MinLength=1
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="dbParameterGroupFamily is immutable"
	DBParameterGroupFamily string `json:"dbParameterGroupFamily"`

	// Description is the description for the cluster parameter group.
	// +kubebuilder:validation:MinLength=1
...
// DBClusterParameterGroup is the Schema for managing RDS Aurora Cluster Parameter Groups.
