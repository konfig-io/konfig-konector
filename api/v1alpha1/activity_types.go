...
// ActivitySpec defines the desired state of a Step Functions activity.
type ActivitySpec struct {
	// Name is the name of the activity. Immutable.
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="name is immutable"
	Name string `json:"name"`

	// Tags are metadata tags for the activity.
	// +optional
...
// +kubebuilder:printcolumn:name="ARN",type="string",JSONPath=".status.activityARN"
// +kubebuilder:printcolumn:name="Ready",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp"

// Activity is the Schema for managing Step Functions activities.
