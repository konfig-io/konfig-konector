...
type ElastiCacheSubnetGroupSpec struct {
	...
	// Description is a human-readable description of the subnet group.
	// +kubebuilder:validation:MinLength=1
...
// ElastiCacheSubnetGroup is the Schema for managing ElastiCache Subnet Groups.
...
// ElastiCacheSubnetGroupList contains a list of ElastiCacheSubnetGroup
