...
// EventBusSpec defines the desired state of an EventBridge Event Bus.
type EventBusSpec struct {
	...
	// EventBusName is the name of the event bus. Immutable.
	// +kubebuilder:validation:MinLength=1
	// +kubebuilder:validation:MaxLength=256
	// +kubebuilder:validation:XValidation:rule="self == oldSelf",message="eventBusName is immutable"
...
// EventBus is the Schema for managing EventBridge Event Buses.
